...
data class NftData(
    ...
    @JsonIgnoreProperties(ignoreUnknown = true) @JsonProperty("collection_logo") val collectionLogo: String?,
    @JsonIgnoreProperties(ignoreUnknown = true) @JsonProperty("collection_banner_image") val collectionBannerImage: String?,
    @JsonIgnoreProperties(ignoreUnknown = true) @JsonProperty("minter_address") val minterAddress: String?
)
...
data class NftMetadata(
    ...
    @JsonIgnoreProperties(ignoreUnknown = true) @JsonProperty("youtube_url") val youtube_url: String? = null
){
    companion object {
